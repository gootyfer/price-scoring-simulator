...
La interfaz está en español y presenta un escenario con cinco licitadores. Se pueden configurar el presupuesto base, el peso del precio y el umbral de baja anormal. Para ejecutarlo basta con abrir `index.html` en un navegador; también puede publicarse directamente con GitHub Pages.
